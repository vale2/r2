...
void drawSensorsSpeed(){
 ...
 ,"soundSpeq_lowFreqBri","soundSpeq_highFreqBri"    ,"soundSpeq_heatPow"
        
        };
        Uint32 c[]={YELLOW,CYAN,RED,BLUE,MAGENTA,GREEN,WHITE,CYAN,GREEN,YELLOW,CYAN,WHITE,MAGENTA,0xaaaaaa,0xffffff,RED};
        drawOptStack(dSc,dX1,dY1,dX2,dY2,s,c,16);
        rectangle(dSc,dX1,dY1,dX2,dY2,BORDERCOLOR);
}
