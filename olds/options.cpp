...
setOpt("pifInterOp3_q",1);
    ...
    zeroCalcOpt("spiral2");
    zeroCalcOpt("mega2");
    zeroCalcOpt("videoZoom",0.5);
    zeroCalcOpt("videoAspect",0.5);
    zeroCalcOpt("videoPosX",0.5);
    zeroCalcOpt("videoPosY",0.5);
    zeroCalcOpt("OVCLoopEnd",1);
    zeroCalcOpt("videoSpeed",1);
