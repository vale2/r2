...
double findEqValueChromaSin(double *freqs,double *amps,int n,double st,double fin){
    double f0;
    double f1;
    double maxfr;
    double eps;
...
double findEqValueChromaCos(double *freqs,double *amps,int n,double st,double fin){
    double f0;
    double f1;
    double maxfr;
    double eps;
